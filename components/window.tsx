...
export default function Window({ as = 'div', title, children, className, ...rest }: Props) {
  return (
    <div className='w-full max-w-[22rem] bg-white/[0.015] bg-gradient-to-tr from-violet-500/5 to-indigo-500/10 hover:bg-gradient-to-br backdrop-blur-lg group/window rounded-lg ring-1 ring-inset ring-white/10 duration-500 hover:ring-white/20'>
      ...
      <ScrollArea className='w-full max-h-[25rem] sm:max-h-[17rem] lg:max-h-[26rem]'>
